...
alias privateend='yes|cp ~/.bash_history.bak ~/.bash_history; for i in {0..10000}; do echo; done; /usr/bin/clear; exec bash'
alias privatestart='yes|cp ~/.bash_history ~/.bash_history.bak;'
